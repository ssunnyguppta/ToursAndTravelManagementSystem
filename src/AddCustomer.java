...
public class AddCustomer extends JFrame implements ActionListener {
    ...
    AddCustomer(String username){
        ...
        //=> to get the RADIO functionality, once selected at a time.
    ...
    public void actionPerformed (ActionEvent ae) {
        if (ae.getSource() == add){
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Customer Details Added Sucessfullly");
                setVisible(false);
            }
            catch (Exception e){
                e.printStackTrace();
